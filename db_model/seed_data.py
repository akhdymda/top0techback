...
def seed_data():
    ...
    try:
        ...
        users = [
            ...
            User(name="佐藤健", email="sato_ken@example.com", password_hash=hash_password("password123")),
            User(name="鈴木大輔", email="suzuki_daisuke@example.com", password_hash=hash_password("password123")),
            User(name="高橋翔太", email="takahashi_shota@example.com", password_hash=hash_password("password123")),
            User(name="田中優子", email="tanaka_yuko@example.com", password_hash=hash_password("password123")),
